      ...
      <div className="flex flex-grow">
        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-purple-600 to-blue-700 text-white items-center justify-center">
          <div className="text-center p-10 m-10">
            <h1 className="text-6xl font-bold mb-8 text-left ">: )</h1>
            <h1 className="text-6xl font-bold mb-8 text-left ">
              Glad to see you!
            </h1>
            <p className="text-xl mr-4 text-left ">
              Create an account and book tickets effortlessly. Manage your
              reservations, track past shows, and access exclusive deals. Enjoy
              a seamless theater experience -- sign up today!
            </p>
          </div>
        </div>
