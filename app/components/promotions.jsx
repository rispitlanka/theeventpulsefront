...
export const Promotions = () => {
  ...
  return (
    <div className="bg-gray-900 w-full py-8">
      <div className="max-w-7xl mx-auto py-10 mb-10 px-4 sm:px-2 lg:px-4">
        <div className="flex justify-between mb-6 px-2">
          ...
          <div className="mr-10">
            <button className="text-gray-200">View All Promotions</button>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center">
          {promotionData.map((item, index) => (
            <div
              key={index}
              className="w-full sm:w-1/2 md:w-1/3 lg:w-1/2 flex mb-4 p-2"
            >
              ...
              <div className="ml-4 flex flex-col justify-center">
                <span
                  ...
                  } text-white text-sm px-2 py-1 rounded-full mb-2`}
                >
                ...
                <button className="bg-purple-600 text-white font-bold w-1/2 py-2 px-3 rounded hover:bg-purple-700">
                  View Deal
                </button>
              </div>
            </div>
